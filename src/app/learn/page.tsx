...
export default function LearnPage() {
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Learn the Norwegian Method</h1>
      ...
      <Card variant="bordered">
        ...
        <CardContent className="prose prose-invert max-w-none">
          ...
          <ul className="list-disc list-inside text-gray-300 space-y-2 mb-4">
            <li>
              <strong className="text-white">High Volume, Low Intensity:</strong> The majority of
              training (80-90%) is done at easy, aerobic paces
            </li>
            <li>
              <strong className="text-white">Threshold Focus:</strong> Quality sessions target
              the lactate threshold, not VO2max intervals
            </li>
            <li>
              <strong className="text-white">Double Threshold Days:</strong> Some athletes perform
              two threshold sessions on the same day
            </li>
            <li>
              <strong className="text-white">Lactate Monitoring:</strong> Training intensity is
              often guided by blood lactate measurements
            </li>
            <li>
              <strong className="text-white">Consistency:</strong> Year-round training with
              gradual progression
            </li>
          </ul>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="p-4 rounded-lg bg-red-500/20 border-l-4 border-red-500">
              <p className="font-medium text-white">Zone 5: VO2max (5%)</p>
            ...
            <div className="p-4 rounded-lg bg-orange-500/20 border-l-4 border-orange-500">
              <p className="font-medium text-white">Zone 4: Threshold (10-15%)</p>
            ...
            <div className="p-4 rounded-lg bg-yellow-500/20 border-l-4 border-yellow-500">
              <p className="font-medium text-white">Zone 3: Tempo (Minimal)</p>
            ...
            <div className="p-4 rounded-lg bg-blue-500/20 border-l-4 border-blue-500">
              <p className="font-medium text-white">Zone 2: Easy Aerobic (75-80%)</p>
            ...
            <div className="p-4 rounded-lg bg-green-500/20 border-l-4 border-green-500">
              <p className="font-medium text-white">Zone 1: Recovery (5%)</p>
    ...
    <>
      <Card variant="bordered">
        ...
        <CardContent className="text-gray-300 space-y-4">
          ...
          <h4 className="text-white font-semibold mt-6 mb-2">Why Threshold Over VO2max?</h4>
          <p>
        ...
        <CardContent className="text-gray-300 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium mb-2">Polarized (Norwegian)</h5>
            ...
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium mb-2">Traditional Pyramidal</h5>
              <ul className="text-sm space-y-1">
                <li>70% easy</li>
                <li>20% moderate</li>
                <li>10% hard</li>
    ...
    <>
      <Card variant="bordered">
        ...
        <CardContent className="text-gray-300 space-y-4">
          ...
          <h4 className="text-white font-semibold mt-4 mb-2">Sample Week Structure</h4>
          <div className="space-y-2">
            <div className="flex justify-between p-3 rounded bg-gray-800">
      ...
      <Card variant="bordered">
        ...
        <CardContent className="text-gray-300">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium">4 x 8 minutes</h5>
              <p className="text-sm text-gray-400">
                Classic format. 2-3 min easy jog recovery. Total: 32 min at threshold.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium">5 x 6 minutes</h5>
              <p className="text-sm text-gray-400">
            ...
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium">3 x 10 minutes</h5>
              <p className="text-sm text-gray-400">
            ...
            <div className="p-4 rounded-lg bg-gray-800">
              <h5 className="text-white font-medium">2 x 15 minutes</h5>
              <p className="text-sm text-gray-400">
        ...
        <CardContent className="text-gray-300 space-y-4">
          <ul className="space-y-3">
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-white">Build Base First:</strong> Spend 2-3 months
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-white">Start with One Threshold Session:</strong> Once
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-white">Use Heart Rate:</strong> If you don&apos;t know your
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-white">Prioritize Consistency:</strong> It&apos;s better to
        ...
        <CardContent className="text-gray-300 space-y-4">
          <ul className="space-y-3">
            <li className="flex gap-3">
              <span className="text-cyan-400">1.</span>
              <span>
                <strong className="text-white">Add a Second Threshold Day:</strong> Once
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">2.</span>
              <span>
                <strong className="text-white">Progress Interval Duration:</strong> Gradually
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">3.</span>
              <span>
                <strong className="text-white">Consider a Long Run:</strong> Add a weekly long
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">4.</span>
              <span>
                <strong className="text-white">Track Your Data:</strong> Monitor pace, heart
        ...
        <CardContent className="text-gray-300 space-y-4">
          <ul className="space-y-3">
            <li className="flex gap-3">
              <span className="text-cyan-400">1.</span>
              <span>
                <strong className="text-white">Experiment with Double Days:</strong> Some
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">2.</span>
              <span>
                <strong className="text-white">Extended Threshold Blocks:</strong> Try longer
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">3.</span>
              <span>
                <strong className="text-white">Consider Lactate Testing:</strong> Blood lactate
            ...
            <li className="flex gap-3">
              <span className="text-cyan-400">4.</span>
              <span>
                <strong className="text-white">Periodization:</strong> Plan your training in
            ...
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-white">Recovery Investment:</strong> At higher volumes,
